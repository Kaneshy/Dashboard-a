...
const page = ({ params }) => {
    ...
    const handleUpload = async (e) => {
        ...
        try {
            const res = await axios.put(`/api/providers/${params.id}`, { ...data })
        ...
        <main>
            {preValue && (<div className="max-w-xl mx-auto mt-4 p-4 bg-blue-main rounded-lg">
                ...
                <div className="mb-4 border-gray-500 border   p-2 w-full">
                    <label htmlFor="username" className="text-small-semibold block text-gray-400 font-bold mb-2 ">brand (required): </label>
                    <input type="text" id="username" name='username' value={preValue.brand} onChange={handleChange} className="border-neutral-500 border  bg-neutral-900 p-2 w-full text-white" />
                </div>
                ...
                <div className="mb-4 border-gray-500 border   p-2 w-full">
                    ...
                    <input type="text" id="manager" name='manager'value={preValue.manager}  onChange={handleChange} className="border-neutral-500 border  bg-neutral-900 p-2 w-full text-white" />
                </div>

                <div className="mb-4 border-gray-500 border   p-2 w-full">
                    <label htmlFor="website" className="text-small-semibold block text-gray-400 font-bold mb-2 ">Website: </label>
                    <input type="text" id="website" name='website'value={preValue.website}  onChange={handleChange} className="border-neutral-500 border  bg-neutral-900 p-2 w-full text-white" />
                </div>
                ...
                <div className="mb-4 items-center border-gray-500 border p-2 w-full">
                    ...
                    <select name='choose' className="border w-full border-gray-300 bg-neutral-900 text-gray-400 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500"
                        value={adminValue} onChange={(e) => setChooseValue(e.target.value)}
                    >
